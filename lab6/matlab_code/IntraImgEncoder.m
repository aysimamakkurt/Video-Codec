...
for rowIndex = 1:params.blockSize:params.nRow
    for colIndex =   1:params.blockSize:params.nCol % write the correct code here
        % Access to the current block
        currentBlock = img(rowIndex:rowIndex+params.blockSize-1, colIndex:colIndex+params.blockSize-1); %% Access to the 8x8 block 
